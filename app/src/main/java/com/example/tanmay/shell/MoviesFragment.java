...
public class MoviesFragment extends Fragment {
    ...
    private void prepareAlbums()
    {
        ...
        a=new Album("Iron Man 3",movies[1]);
        albumList.add(a);

        a=new Album("The Dark Knight",movies[2]);
        albumList.add(a);

        a=new Album("Civil War",movies[3]);
        albumList.add(a);

        a=new Album("Suicide Squad",movies[4]);
        albumList.add(a);

        a=new Album("American Pie",movies[5]);
        albumList.add(a);
