...
public class OthersFragment extends Fragment {
    ...
    static ArrayList<String> name_stationary=new ArrayList<String>();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < js.length(); i++) {
                        ...
                        name_stationary.add(c.getString("name"));
                    ...
                    while (i < js.length())
                    {
                        Album a = new Album(name_stationary.get(i), R.mipmap.ic_launcher,time_span[i]);
                        albumList.add(a);
                        i++;
